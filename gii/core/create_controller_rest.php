...
class " . $c . " extends REST_Controller
{
    ...
    function __construct()
    {
        ...
        //Load Model ".ucfirst($c_url)."
        \$this->load->model('$m');
        
        //Konfigurasi Request ".ucfirst($c_url)."
        \$big = 4;
        \$medium = 3;
        \$small = 2;

        //Method Controller ".ucfirst($c_url)."
        \$this->methods['index_get']['limit'] = \$big; 
        \$this->methods['list".ucfirst($c_url)."_get']['limit'] = \$big; 
    ...
    // Method \t: POST
    ---------------------------------------------------------------- */
    public function list".ucfirst($c_url)."_get()
    {
